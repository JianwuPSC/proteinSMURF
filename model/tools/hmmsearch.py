...
from model.tools import hmmbuild
from model.tools import utils
...
class Hmmsearch(object):
  ...
  def get_template_hits(self,
                        output_string: str,
                        input_sequence: str) -> Sequence[parsers_af2.TemplateHit]:
    """Gets parsed template hits from the raw string output by the tool."""
    a3m_string = parsers_af2.convert_stockholm_to_a3m(output_string,
                                                  remove_first_row_gaps=False)
    template_hits = parsers_af2.parse_hmmsearch_a3m(
