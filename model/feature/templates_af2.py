...
from model.feature import mmcif_parsing_af2
from model.feature import parsers_af2
from model.tools import kalign
import numpy as np
...
def _get_pdb_id_and_chain(hit: parsers_af2.TemplateHit) -> Tuple[str, str]:
...
def _find_template_in_pdb(
    ...
    mmcif_object: mmcif_parsing_af2.MmcifObject) -> Tuple[str, str, int]:
...
def _realign_pdb_template_to_query(
    ...
    template_chain_id: str,
    mmcif_object: mmcif_parsing_af2.MmcifObject,
...
def _process_single_hit(
  ...
  parsing_result = mmcif_parsing_af2.parse(
...
class TemplateHitFeaturizer(abc.ABC):
  ...
  def get_templates(
      self,
      query_sequence: str,
      hits: Sequence[parsers_af2.TemplateHit]) -> TemplateSearchResult:
